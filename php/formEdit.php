...
<head>
	...
	<body>
			...
			<form enctype="multipart/form-data" class="form-horizontal" action="edit.php" method="POST">
					<fieldset>
...
</html>  EDIT form do zrobienbia - po checkbox i kliknieciu edit - uruchomi sie FormEDIT.